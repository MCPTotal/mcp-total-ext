...
class UIManager {
  ...
  createSettingsMenu(toolCall, toolButton) {
    ...
    const manualButton = this.createModeButton('Manual', 'manual', currentMode, 
      `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>`,
      toolCall, toolButton);
    
    const autoRunButton = this.createModeButton('Auto-run', 'autorun', currentMode,
      `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>`,
      toolCall, toolButton);
    
    const autoSendButton = this.createModeButton('Auto-run and send', 'autosend', currentMode,
...
if (typeof exposeModule === 'function') {
  ...
  if (currentScript && currentScript.id) {
    window[currentScript.id] = UIManager;
  }
} 